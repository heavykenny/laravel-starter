                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="{{route("register")}}" method="POST">
                            ...
                            <div class="form-label-group">
                                <input name="password_confirmation" type="password" id="inputConfirmPassword"
                                       class="form-control"
                            ...
                            <br>
                            <a href="{{route("login")}}">
                                <p class="text-center text-uppercase"><span class="badge badge-pill badge-success">Sign in</span></p>
                            </a>
                            <hr class="my-4">
